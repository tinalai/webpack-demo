...
var makeSchema = function makeSchema(schemaOptions, schemaExtension) {
...
module.exports = function validate(config) {
  ...
  returnValidation = options.returnValidation;
  var // bool
  quiet = options.quiet;
  var overrideSchema = options.schema;
  var // Don't take internal schema, but override with this one
  schemaExtension = options.schemaExtension;
  var // Internal schema will be `Joi.concat`-ted with this schema if supplied
  rules = options.rules;
